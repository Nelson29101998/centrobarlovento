...
if (!isset($_SESSION["usuario"]) && !isset($_SESSION["rut"])) {
    ...
    include_once "../../../../conectarSQL/conectar_SQL.php";
        ...
        $sqlCuentaPro = "INSERT INTO profesor (nombre, nacimiento, rut, telefono, mail, direccion, areaDocente, otroDato, usuario, clave)
        VALUES ('" . $nomPro . "','" . $nacePro . "','" . $rutPro . "','" . $telPro . "','" . $correoPro . "','" . $dirPro . "','" . $areaPro . "','" . $otroPro . "','" . $userPro . "','" . $passwordPro . "')";
